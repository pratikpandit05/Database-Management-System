...
#line 1 "Parser.y"
	...
	struct NameList *sortAtts;//stores the AndList for the sort order
...
{
       0,     0,     3,    10,    20,    29,    40,    44,    49,    53,
      57,    61,    65,    67,    69,    72,    77,    83,    85,    89,
      92,    95,    98,   100,   104,   108,   114,   118,   124,   128,
     130,   133,   135,   137,   139,   141,   147,   151,   155,   157,
...
{
      43,     0,    -1,     7,    44,    11,    49,    13,    52,    -1,
       7,    44,    11,    49,    13,    52,     8,    10,    48,    -1,
      18,    19,     3,    32,    46,    33,    15,    22,    -1,    18,
      19,     3,    32,    46,    33,    15,    23,    27,    48,    -1,
      12,    19,     3,    -1,    20,     6,    21,     3,    -1,    28,
      29,    30,    -1,    28,    29,    31,    -1,    28,    29,     6,
      -1,    45,    34,    48,    -1,    45,    -1,    48,    -1,     9,
      48,    -1,    14,    32,    50,    33,    -1,    14,     9,    32,
      50,    33,    -1,    47,    -1,    47,    34,    46,    -1,     3,
      24,    -1,     3,    25,    -1,     3,    26,    -1,     3,    -1,
      48,    34,     3,    -1,     3,    15,     3,    -1,    49,    34,
       3,    15,     3,    -1,    57,    51,    50,    -1,    32,    50,
      33,    51,    50,    -1,    32,    50,    33,    -1,    57,    -1,
      35,    50,    -1,    35,    -1,    36,    -1,    37,    -1,    38,
      -1,    32,    53,    33,    16,    52,    -1,    32,    53,    33,
      -1,    54,    17,    53,    -1,    54,    -1,    56,    55,    56,
      -1,    39,    -1,    40,    -1,    41,    -1,     6,    -1,     4,
      -1,     5,    -1,     3,    -1,     4,    -1,     5,    -1,     3,
      -1
};
...
{
       0,   111,   111,   119,   127,   136,   147,   154,   161,   166,
     171,   178,   184,   189,   196,   204,   210,   218,   222,   228,
     236,   244,   253,   260,   267,   275,   285,   298,   308,   314,
     323,   334,   339,   344,   349,   355,   369,   378,   386,   395,
     404,   411,   418,   426,   434,   442,   450,   462,   470,   478
};
#endif
...
static const char *const yytname[] =
{
  ...
  "SELECT", "GROUP", "DISTINCT", "BY", "FROM", "DROP", "WHERE", "SUM",
  "AS", "AND", "OR", "CREATE", "TABLE", "INSERT", "INTO", "HEAP", "SORTED",
  "INTEGER", "DOUBLE", "STRING", "ON", "SET", "OUTPUT", "STDOUT", "NONE",
  "'('", "')'", "','", "'-'", "'+'", "'*'", "'/'", "'<'", "'>'", "'='",
  "$accept", "SQL", "WhatIWant", "Function", "Lst", "ls", "Atts", "Tables",
...
static const yytype_uint8 yydefact[] =
{
       ...
       0,    12,    13,     0,     0,     0,     0,     1,    14,     0,
       0,     0,     0,     0,     6,     0,     0,    10,     8,     9,
       0,    49,    47,    48,     0,     0,     0,    29,     0,     0,
      11,    23,     0,     7,     0,     0,    30,    15,    31,    32,
      33,    34,     0,     0,     0,     0,     0,     0,    17,    16,
      28,    26,    24,     0,     2,     0,    19,    20,    21,     0,
       0,     0,    46,    44,    45,    43,     0,    38,     0,     0,
       0,     0,    18,    27,    36,     0,    40,    41,    42,     0,
       0,    25,     4,     0,     0,    37,    39,     3,     0,    35,
       5
};
...
{
       8,    10,     6,    16,    15,    -7,    27,   -30,    26,    -2,
      38,    17,    18,    47,    50,    33,     2,   -30,    18,    23,
      -1,    53,    26,    54,   -30,    28,    55,   -30,   -30,   -30,
      -1,   -30,   -30,   -30,    -1,    -1,    29,   -26,    44,     3,
      18,   -30,    58,   -30,    30,    31,   -30,   -30,   -30,   -30,
     -30,   -30,    -1,    62,    34,    64,    19,    36,    37,   -30,
     -26,   -30,   -30,    35,    60,    57,   -30,   -30,   -30,    59,
      58,    -1,   -30,   -30,   -30,   -30,    40,    61,     7,    65,
      67,    -5,   -30,   -30,    63,    35,   -30,   -30,   -30,    35,
      26,   -30,   -30,    49,    34,   -30,   -30,    18,    26,   -30,
      18
};
...
{
      18,    44,    31,    32,    33,    45,    46,    19,    27,    48,
      49,    50,    51,     7,    40,     1,    54,    92,    93,     8,
       2,    15,    16,    61,     9,    13,     3,    17,     4,     7,
      20,    34,    28,    29,    35,    14,     5,    55,    72,    73,
      74,    75,    83,    66,    67,    68,    86,    87,    88,    21,
      24,    22,    23,    25,    26,    30,    38,    41,    43,    53,
      42,    56,    47,    59,    60,    62,    63,    65,    79,    69,
      91,    70,    80,    84,    81,    90,    98,    99,    85,    94,
      71,    82,    97,    96,     0,    95,     0,     0,     0,     0,
     100
};
...
{
       8,    30,     3,     4,     5,    34,    35,     9,     6,    35,
      36,    37,    38,     3,    22,     7,    13,    22,    23,     9,
      12,     6,    29,    52,    14,    19,    18,     0,    20,     3,
      32,    32,    30,    31,    35,    19,    28,    34,     3,     4,
       5,     6,    71,    24,    25,    26,    39,    40,    41,    11,
       3,    34,    34,     3,    21,    32,     3,     3,     3,    15,
      32,     3,    33,    33,    33,     3,    32,     3,     8,    33,
       3,    34,    15,    33,    15,    10,    27,    94,    17,    16,
      60,    70,    90,    89,    -1,    85,    -1,    -1,    -1,    -1,
      98
};
...
{
       0,     7,    12,    18,    20,    28,    43,     3,     9,    14,
      44,    45,    48,    19,    19,     6,    29,     0,    48,     9,
      32,    11,    34,    34,     3,     3,    21,     6,    30,    31,
      32,     3,     4,     5,    32,    35,    50,    57,     3,    49,
      48,     3,    32,     3,    50,    50,    50,    33,    35,    36,
      37,    38,    51,    15,    13,    34,     3,    46,    47,    33,
      33,    50,     3,    32,    52,     3,    24,    25,    26,    33,
      34,    51,     3,     4,     5,     6,    53,    54,    56,     8,
      15,    15,    46,    50,    33,    17,    39,    40,    41,    55,
      10,     3,    22,    23,    16,    53,    56,    48,    27,    52,
      48
};
...
#line 128 "Parser.y"
	...
	tb->name=(yyvsp[(3) - (8)].actualChars);
	tb->type=1;
	tb->att=(yyvsp[(5) - (8)].myAtt);
}
    break;
...
#line 137 "Parser.y"
	...
	create=1;
	tb=(struct Table *)malloc(sizeof (struct Table));
	tb->name=(yyvsp[(3) - (10)].actualChars);
	tb->type=2;
	tb->att=(yyvsp[(5) - (10)].myAtt);
	sortAtts=(yyvsp[(10) - (10)].myNames);
}
    break;
...
#line 155 "Parser.y"
    {
	insert=1;
	myfile=(yyvsp[(2) - (4)].actualChars);
	mytable=(yyvsp[(4) - (4)].actualChars);
}
    break;
...
#line 223 "Parser.y"
    {
	(yyval.myAtt)=(yyvsp[(1) - (3)].myAtt);
	(yyval.myAtt)->next=(yyvsp[(3) - (3)].myAtt);
}
    break;
...
#line 229 "Parser.y"
    {
	(yyval.myAtt)=(struct AttList*)malloc(sizeof(struct AttList));
	(yyval.myAtt)->name=(yyvsp[(1) - (2)].actualChars);
	(yyval.myAtt)->type=0; //modify here for double/string type
	(yyval.myAtt)->next=NULL;
}
    break;
...
#line 237 "Parser.y"
	...
	(yyval.myAtt)=(struct AttList*)malloc(sizeof(struct AttList));
	(yyval.myAtt)->name=(yyvsp[(1) - (2)].actualChars);
	(yyval.myAtt)->type=1; //modify here for double/string type
	(yyval.myAtt)->next=NULL;
}
    break;
...
#line 245 "Parser.y"
	...
	(yyval.myAtt)=(struct AttList*)malloc(sizeof(struct AttList));
	(yyval.myAtt)->name=(yyvsp[(1) - (2)].actualChars);
	(yyval.myAtt)->type=2; //modify here for double/string type
	(yyval.myAtt)->next=NULL;
}
    break;
